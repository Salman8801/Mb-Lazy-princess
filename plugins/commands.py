...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton("⚜️ 𝚄𝙿𝙳𝙰𝚃𝙴𝚂 ⚜️", url="https://t.me/mkn_bots_updates")
            ],[      
        ...
        m=await message.reply_sticker("CAACAgQAAxkBAAECh2Jkx-l9iyPBRt4zCvptqK1yg9aSewACLgMAAnJxFyVEOdCPgmRqOh4E")
